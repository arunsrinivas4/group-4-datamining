<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Your_account.aspx.cs" Inherits="Your_account" %>
    ...
    <div style="width:100%;">
     <img src="Images/Books.jpg" alt="Books" style="width:100%;height: 161px" />
      ...
      <div><asp:ValidationSummary ID="validationsumary1" ValidationGroup="form" ShowMessageBox="true" ShowSummary="false" runat="server" /></div>
        <div style="font-size:32px;color:brown;font-weight:bold;background-color:deepskyblue">Your Account Information</div>
        <div style="width:100%">
             <div id="div1"style="width:100%; float:left; height: 367px;background-color:#bec3c6;border-bottom-width:1px;border-bottom-color:black;border-style:inset">
                    <p style="font-size:32px;color:blue;font-weight:bold">Personal Information</p>
                    <p style="width: 100%;color:brown;font-size:26px;"> If you wish,you can update the account information and then click 'Update' or 'Update and Goto Main Page' button below.</p>
                    <table>
                        <tr>
                          <td>  <asp:Label ID="Label1" runat="server" Text=" Your Name<font>*</font>" ></asp:Label></td>
                          <td><asp:TextBox ID="TextBox1" ReadOnly="true" runat="server"  Width="280px"></asp:TextBox></td>
                          <td>
        ...
        <div id="id2" style="border-bottom: 1px inset black; width:100%; float:left; height: 192px; background-color:#bec3c6; border-left-style: inset; border-right-style: inset; border-top-style: inset;">
            ...
            <table>
                <tr>
                    ...
                    <td><asp:TextBox ID="TextBox6" runat="server" ReadOnly="true"  Width="280px"></asp:TextBox></td>
                    <td>
        ...
        <div id="id3" style="width:100%;float:left; height: 150px;border-bottom-width:1px;background-color:#bec3c6;border-bottom-color:black;border-style:inset">
            <span style="color:blue;font-size:22px">Pay me by</span>
            <br />
            <br />
            <div>
                ...
                <asp:Button ID="Button3" runat="server" ValidationGroup="form" style="margin-left: 137px; margin-top:0px; color:red;font-size:20px" Text="Update" Width="319px" Height="35px" OnClick="Button3_Click" />
            </div>                     
        </div>
    </form>
</body>
